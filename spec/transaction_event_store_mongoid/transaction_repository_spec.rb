...
describe TransactionEventStoreMongoid::Repository do
  subject { described_class.new adapter: TransactionEventStoreMongoid::Transaction }
  ...
  specify 'initialize with adapter' do
    ...
    expect(repository.adapter).to eq(TransactionEventStoreMongoid::Transaction )
  end
  ...
  describe 'event ordering' do
    ...
    def create_event(event_id:, stream: stream_name)
      TransactionEventStoreMongoid::Transaction.create!(
